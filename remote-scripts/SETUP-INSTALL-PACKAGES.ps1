...
#Get VMs deployed in the service..
        ...
        try{
            ...
            {  
                ...
                $output = RunLinuxCmd -username $user -password $password -ip $hs1VIP -port $hs1vm1sshport -command "python ./$($currentTestData.testScript)" -runAsSudo -runMaxAllowedTime 2400
            }  
